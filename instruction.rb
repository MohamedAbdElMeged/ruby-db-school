class Instruction
    ...
    def search
        ...
        if search_class == "student"
            ...
            puts Student.find_by(search_query).student_data
        else
            ...
            puts ClassRoom.find_by(search_query).class_data
        end
    ...
    def insert_new_student(class_room_id=nil)
        ...
        new_student = Student.create!(name:student_name, phone:student_phone,address: student_address,class_room_id: class_room_id )
    end
